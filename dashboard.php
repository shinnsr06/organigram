...
$sql = "SELECT * FROM siswa WHERE role <> 'Siswa' ORDER BY 
        CASE 
            WHEN role = 'Ketua Kelas' THEN 1 
            WHEN role = 'Wakil Ketua Kelas' THEN 2 
            WHEN role = 'Sekretaris' THEN 3 
            WHEN role = 'Absensi' THEN 4 
            WHEN role = 'Bendahara' THEN 5 
            ELSE 6 
        END";
  ...
  <div class="container-xl">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-lg-auto">
        <a class="nav-item nav-link active" href="dashboard.php" aria-current="page">Dashboard</a>
        <?php
...
<h3 class="mt-5 text-center">Data Siswa</h3>
    ...
    if (!empty($siswa_data)) {
        ...
        echo '<tr class="table-warning"><th>Nama</th><th>Role</th></tr>';
        ...
        echo 'Tidak ada data siswa yang bukan "Siswa".';
    }
    ?>
</div>
